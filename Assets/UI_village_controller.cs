...
public class UI_village_controller : MonoBehaviour
{
    ...
    private void Update()
    {
        evil_count = Convert.ToInt32(flowchart.GetBooleanVariable("ReligionA_right")) + Convert.ToInt32(flowchart.GetBooleanVariable("ReligionB_right"))
            + Convert.ToInt32(flowchart.GetBooleanVariable("ReligionD_right")) + Convert.ToInt32(flowchart.GetBooleanVariable("ReligionC_right"));
        ...
        backpackswitch[1] = flowchart.GetBooleanVariable("OrderTaskReceived");
        backpackswitch[2] = flowchart.GetBooleanVariable("DoneOrderTask");
    ...
    void OnGUI()
    {
        ...
        //    var item = flowchart.GetBooleanVariable("hasSword");
